...
#pragma endregion
	...
	commandList->RSSetViewports(1, &viewport);            // Viewporta
	commandList->SetGraphicsRootSignature(rootSignature); // Scirssorを設定
	// RootSignatureを設定。PSOに設定しているけど別途設定が必要
	commandList->SetPipelineState(graphicsPipelineState);
	commandList->IASetVertexBuffers(0, 1, &vertexBufferView);                 // PSOを設定
	commandList->IASetPrimitiveTopology(D3D_PRIMITIVE_TOPOLOGY_TRIANGLELIST); // VBVを設定
